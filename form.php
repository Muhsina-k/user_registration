...
if (isset($_POST['submit'])) 
{
	...
	$password=$_POST['password'];
	 ...
	 mysqli_query($con,"INSERT INTO `form_example`( `login_id`, `name`, `email`, `gender`, `district`, `mobno`, `photo`, `qualification`) VALUES ('$login_id','$name','$email','$gender','$District','$mobile','$file_name','$qu')");
                                                                                                                                                                                                                                                                                                                                                              

    echo $name."<br>".$email."<br>".$gender."<br>".$District."<br>".$mobile."<br>".$file_name."<br>".$qu."<br>".$username."<br>".$password."<br>";
}
...
mob no:<input type="number" id="mobno" name="mobno">
